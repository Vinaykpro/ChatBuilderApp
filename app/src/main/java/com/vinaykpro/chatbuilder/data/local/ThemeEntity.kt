...
data class BodyStyle(
    ...
    val color_text_primary_dark: String = "#FFffffff",
    val color_text_secondary_dark: String = "#FFbfbfbf",
...
data class MessageBarStyle(
    ...
    val color_leftinnerbutton_icon: String = "#FF444444",
    val color_icons: String = "#FF444444",
    ...
    val color_leftinnerbutton_icon_dark: String = "#FFdddddd",
    val color_icons_dark: String = "#FFdddddd",
